      ...
      <div className="signup-box">
        ...
        <form className="signup-form" onSubmit={ onSubmitSignUp } >
          <div className="form-group">
            ...
            <input type="text" id="userName" placeholder="Enter your username" onChange={handleInputChange} value={formData.userName}/>
          </div>
          ...
          <div className="form-group">
            ...
            <input type="tel" id="phone" placeholder="Enter your phone number" value={formData.phone} onChange={handleInputChange} />
          </div>
          ...
          <div className="form-group">
            ...
            <input type="password" id="passwordConfirm" placeholder="Re-enter password" value={formData.passwordConfirm} onChange={handleInputChange} />
          </div>
